...
дистрибутиве AMD. Драйвер наружу торит богатым набором `METHOD_BUFFERED`
...
В рекомендованном Microsoft блоклисте уязвимых драйверов - семпла пока нет.
...
| `0xFFF02900` | `0x140001368` | 0x118/0x14 | форвард запрос в другой девайс |
| `0xFFF02940` | `0x140002A14` | 0x18 | форвард запрос в другой девайс |

Пункты с пометкой «команда SMU/MP1» прокидывают мелкие фиксированные
пейлоады в mailbox AMD SMU — глубоко их не аудировал; некоторые из них
...
Драйвер создаёт root-enumerated PnP-девноду, открывает
